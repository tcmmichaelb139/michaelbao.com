...
<svelte:head>
	<title>{title} | Michael Bao</title>
	<meta name="description" content={description} />
	<meta property="og_site_name" content="michaelbao.io" />
	<meta property="og:url" content="https://michaelbao.io{$page.url.pathname.toString()}" />
